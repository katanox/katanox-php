...
/**
 * HttpCustomer Class Doc Comment
 *
 * @category Class
 * @package  Katanox
 * @author   OpenAPI Generator team
 ...
 */
class HttpCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'http.Customer';
    ...
    */
     ...
     * Sets birth_date
     *
     * @param string|null $birth_date Example: 2021-10-09
     *
     * @return self
     */
     ...
     * Sets company_name
     *
     * @param string|null $company_name Can be used to specify the customer's company name. If you create a booking on behalf of a customer of yours you can use their company name which will appear as the customer's company. Otherwise, you can use your company's name
     *
     * @return self
     */

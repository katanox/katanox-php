...
class HttpBookingCreationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets payment
     *
     * @param \Katanox\Model\HttpPayment|null $payment The payment field is required only if you provide your own credit cards for suppliers. If you need clarification on your payment flow, please reach out to your account manager.
     *
     * @return self
     */

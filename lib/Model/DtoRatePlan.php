...
class DtoRatePlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payment_modes', $data ?? [], null);
    ...
    */
     ...
     * Sets payment_modes
     *
     * @param string[]|null $payment_modes payment_modes
     *
     * @return self
     */
    public function setPaymentModes($payment_modes)
    {
        if (is_null($payment_modes)) {
            throw new \InvalidArgumentException('non-nullable payment_modes cannot be null');
        }

...
class AvailabilityExternalOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'id' => 'setId',
        'occupancy_index' => 'setOccupancyIndex',
        'price' => 'setPrice',
    ...
    protected static $getters = [
        ...
        'id' => 'getId',
        'occupancy_index' => 'getOccupancyIndex',
        'price' => 'getPrice',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('occupancy_index', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets occupancy_index
     *
     * @return int|null
     */
    public function getOccupancyIndex()
    {
        return $this->container['occupancy_index'];
    }

    /**
     * Sets occupancy_index
     *
     * @param int|null $occupancy_index occupancy_index
     *
     * @return self
     */
    public function setOccupancyIndex($occupancy_index)
    {
        if (is_null($occupancy_index)) {
            throw new \InvalidArgumentException('non-nullable occupancy_index cannot be null');
        }
        $this->container['occupancy_index'] = $occupancy_index;

...
class PropertiesApi
{
     ...
     * @param  string[]|null $property_ids List of property IDs to be included. When specified, only these properties will be included in the response. The maximum size of this list is 50. (optional)
     ...
     * @return \Katanox\Model\ModelGetPropertiesResponse|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError
     */
     ...
     * @throws \Katanox\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Katanox\Model\ModelGetPropertiesResponse|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Katanox\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Katanox\Model\ModelGetPropertyByIdResponse|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError
     */
     ...
     * @throws \Katanox\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Katanox\Model\ModelGetPropertyByIdResponse|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError|\Katanox\Model\ModelApiError, HTTP status code, HTTP response headers (array of strings)
     */

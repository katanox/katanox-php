...
class BookingResource
{
    ...
    {
        $this->BASE_URL = 'https://api.pci-proxy.com/v1/push/5775c7cf3b3e5dc0/v1/bookings';
        $this->client = $client;
        $this->apiKey = $apiKey;
    ...
    public function getBooking(string $bookingId): GetBookingResult
    {
        $req = new KatanoxRequest(
            'GET',
            sprintf('%s/%s', $this->BASE_URL, $bookingId),
            $this->apiKey,
            []
        );
        $res = $this->client->request(
    ...
    public function createReservation(CreateReservationRequest $createReservationRequest): CreateReservationResult
    {
        ...
        $req = new KatanoxRequest(
            'POST',
            sprintf('%s/%s/reservations', $this->BASE_URL, $createReservationRequest->getBookingId()),
            $this->apiKey,
    ...
    public function getReservation(string $bookingId, string $reservationId): GetReservationResult
    {
        $req = new KatanoxRequest(
            'GET',
            sprintf('%s/%s/reservations/%s', $this->BASE_URL, $bookingId, $reservationId),
            $this->apiKey,
            []
        );
        $res = $this->client->request(
